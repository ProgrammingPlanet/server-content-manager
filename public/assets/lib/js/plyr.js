"object" == typeof navigator && function(e, t) {
        ...
        bindMenuItemShortcuts: function(e, t) {
            ...
            ke.call(this, e, "keydown keyup", (function(n) {
                if ([32, 38, 39, 40].includes(n.which) && (n.preventDefault(), n.stopPropagation(), "keydown" !== n.type)) {
                    ...
                    else 32 !== n.which && (40 === n.which || s && 39 === n.which ? (a = e.nextElementSibling, W(a) || (a = e.parentNode.firstElementChild)) : (a = e.previousElementSibling, W(a) || (a = e.parentNode.lastElementChild)), fe.call(i, a, !0))
                }
    ...
    var Je = {
            setup: function() {
                if (this.supported.ui)
                    if (!this.isVideo || this.isYouTube || this.isHTML5 && !ve.textTracks) B(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Ye.setCaptionsMenu.call(this);
                    else {
    ...
    var ht = {
        ...
        ready: function() {
            ...
            var s, o = X(s = a) ? null : D(Number(s)) ? s : s.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : s,
                l = ne("iframe"),
    ...
    var ft = {
            ...
            ready: function() {
                ...
                if (X(t) || !t.startsWith("youtube-")) {
                    ...
                    var n, a, s = X(n = i) ? null : n.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : n,
